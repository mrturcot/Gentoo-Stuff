...
echo "make oldconfig"
sleep 1
make LLVM=1 LLVM_IAS=1 -j14 oldconfig
make LLVM=1 LLVM_IAS=1 -j14 modules_prepare
echo "make && install kernel"
sleep 1
make LLVM=1 LLVM_IAS=1 -j14
make LLVM=1 LLVM_IAS=1 -j14 install
make LLVM=1 LLVM_IAS=1 -j14 modules_install
