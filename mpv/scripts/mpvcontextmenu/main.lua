...
local guiDialogs = require "gui-dialogs"
...
mp.register_event("file-loaded", function()
    menuList = {
        ...
        abrepeat_menu = {
            ...
            {CHECK, "Toggle Infinite Loop", "", "cycle-values loop-file \"inf\" \"no\"", function() return stateFileLoop() end, false, true},
        },
        ...
        aspect_menu = {
            {COMMAND, "Reset", "Ctrl+Shift+R", "no-osd set video-aspect-override \"-1\" ; no-osd set video-aspect-override \"-1\" ; show-text \"Video Aspect Ratio - Reset\"", "", false, true},
            {COMMAND, "Select Next", "", "cycle-values video-aspect-override \"4:3\" \"16:10\" \"16:9\" \"1.85:1\" \"2.35:1\" \"-1\" \"-1\"", "", false, true},
            {SEP},
            {RADIO, "4:3 (TV)", "", "set video-aspect-override \"4:3\"", function() return stateRatio("4:3") end, false, true},
            {RADIO, "16:10 (Wide Monitor)", "", "set video-aspect-override \"16:10\"", function() return stateRatio("16:10") end, false, true},
            {RADIO, "16:9 (HDTV)", "", "set video-aspect-override \"16:9\"", function() return stateRatio("16:9") end, false, true},
            {RADIO, "1.85:1 (Wide Vision)", "", "set video-aspect-override \"1.85:1\"", function() return stateRatio("1.85:1") end, false, true},
            {RADIO, "2.35:1 (CinemaScope)", "", "set video-aspect-override \"2.35:1\"", function() return stateRatio("2.35:1") end, false, true},
            {SEP},
            {COMMAND, "+" .. opt.vidAspect .. "%", "Ctrl+Shift+A", "add video-aspect-override " .. (opt.vidAspect / 100), "", false, true},
            {COMMAND, "-" .. opt.vidAspect .. "%", "Ctrl+Shift+D", "add video-aspect-override -" .. (opt.vidAspect / 100), "", false, true},
        },
