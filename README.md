**My Gentoo / Linux Stuff**
 ...
 /etc/portage files included in this repo, could serve as drop-in replacements for other similar setups. One helpful use case scenario would be... Once initially mounted and chrooted into a new Gentoo install, download this repo as a zip=[https://github.com/mrturcot/Gentoo-Stuff/archive/refs/heads/master.zip] using wget. Then extract the repo then edit/use/rm any configs as deemed needed to get you going way ahead of schedule :)
