...
<sub>~~kernel not included~~, however you could possibly use a kernel.bin [*not recommended as thats pretty lame*] unless however its my rolled up kernel thats *extra* cool :) eg. sys-kernel/gentoo-kernel-bin</sub>   
