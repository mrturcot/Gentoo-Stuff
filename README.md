...
```
  ...
  - Portage & Kernel setup for a Stable Gentoo x86-64 EFI based, Ryzen Zen-Ver.1 AMDGPU OpenRC Gnome-*Light* X11 Pipewire system, configured with optimizations for speed and gaming performance in mind... 
